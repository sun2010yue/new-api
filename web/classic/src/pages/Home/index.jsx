...
const Home = () => {
  ...
  const reviews = [
    { quote: t('用了 New API 之后，我们的 AI 成本直接降低了 45%，服务还特别稳定，太赞了！'), name: t('张工程师'), title: t('某科技公司'), bg: '#3b82f6' },
    { quote: t('一个API调用所有模型，开发效率提升了好几倍，价格还这么便宜！'), name: t('李产品'), title: t('某创业公司'), bg: '#8b5cf6' },
    { quote: t('99.99% 的可用性，我们的业务再也没因为AI服务掉过链子！'), name: t('王架构师'), title: t('某大厂'), bg: '#10b981' },
  ];

  const services = ['GPT-4o', 'GPT-4o-mini', 'Claude 3.5 Sonnet', 'Claude 3.5 Haiku', 'Gemini 2.0', 'Qwen3-Max', 'DeepSeek V3', 'DeepSeek R1'];
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex justify-between items-center h-16'>
          <div className='flex items-center'>
            ...
            <span className='ml-3 text-xl font-bold text-semi-color-text-0'>New API</span>
          </div>
    ...
    <section ref={heroRef} className='home-hero-gradient pt-32 pb-24 relative overflow-hidden'>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative' style={{ zIndex: 10 }}>
        <div className='text-center'>
          <div className='inline-flex items-center px-4 py-2 rounded-full mb-8' style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(8px)' }}>
            <span className='w-2 h-2 home-bg-green-400 rounded-full mr-2 animate-pulse' />
            <span className='home-text-slate-200 text-sm font-medium'>
              {t('已服务 100,000+ 开发者')} · 99.99% {t('可用性')}
            </span>
          </div>
            ...
            <div className='flex flex-col items-center mt-4'>
              ...
              <div className='flex items-center gap-2'>
                <div className='flex items-center home-bg-white-10 backdrop-blur rounded-full px-4 py-2 home-border-white-20'>
                  ...
                  <span className='home-text-white font-mono text-sm mx-2'>{serverAddress}</span>
                  <button
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto'>
            {[
              { num: '100+', label: t('AI模型') },
              { num: '40%', label: t('平均节省') },
              { num: '99.99%', label: t('服务可用性') },
    ...
    <footer className='home-dark-gradient home-text-slate-400 py-16'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid md:grid-cols-4 gap-12 mb-12'>
          <div>
            <div className='flex items-center mb-6'>
              ...
              <span className='ml-3 text-xl font-bold home-text-white'>New API</span>
            </div>
        ...
        <div className='border-t pt-8 text-center' style={{ borderColor: 'rgba(255,255,255,0.1)' }}>
          <p>&copy; 2026 New API. {t('All rights reserved.')}</p>
        </div>
      </div>
    </footer>
  );
